...
class PunchBlocksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create punch_block" do
    assert_difference('PunchBlock.count') do
      post punch_blocks_url, params: { punch_block: { block: @punch_block.block, block_location: @punch_block.block_location, block_number: @punch_block.block_number, block_type: @punch_block.block_type, description: @punch_block.description } }
    end
  ...
  test "should update punch_block" do
    patch punch_block_url(@punch_block), params: { punch_block: { block: @punch_block.block, block_location: @punch_block.block_location, block_number: @punch_block.block_number, block_type: @punch_block.block_type, description: @punch_block.description } }
