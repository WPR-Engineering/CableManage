...
class TerminalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create terminal" do
    assert_difference('Terminal.count') do
      post terminals_url, params: { terminal: { PunchBlock_id: @terminal.PunchBlock_id, terminal_number: @terminal.terminal_number, terminal_type: @terminal.terminal_type } }
    end
  ...
  test "should update terminal" do
    patch terminal_url(@terminal), params: { terminal: { PunchBlock_id: @terminal.PunchBlock_id, terminal_number: @terminal.terminal_number, terminal_type: @terminal.terminal_type } }
