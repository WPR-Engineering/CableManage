...
class WiresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wire" do
    assert_difference('Wire.count') do
      post wires_url, params: { wire: { multi_core: @wire.multi_core, number: @wire.number, wire_type: @wire.wire_type } }
    end
  ...
  test "should update wire" do
    patch wire_url(@wire), params: { wire: { multi_core: @wire.multi_core, number: @wire.number, wire_type: @wire.wire_type } }
