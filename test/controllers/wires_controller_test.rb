...
class WiresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wire" do
    assert_difference('Wire.count') do
      post wires_url, params: { wire: { multi_pair: @wire.multi_pair, signal_type: @wire.signal_type, wire_description: @wire.wire_description, wire_number: @wire.wire_number, wire_type: @wire.wire_type } }
    end
  ...
  test "should update wire" do
    patch wire_url(@wire), params: { wire: { multi_pair: @wire.multi_pair, signal_type: @wire.signal_type, wire_description: @wire.wire_description, wire_number: @wire.wire_number, wire_type: @wire.wire_type } }
